...
options = {
    ...
    'lanczos':OFF,
    'libs':[],
    'listener_name':'MS-RHMIWUFDWSIP',
    'listener_resource':'8828',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'mp_head_node':('ms-rhmiwufdwsip', '172.16.1.23', '192.168.50.10', '192.168.192.10'),
    'mp_host_list':(('ms-rhmiwufdwsip', 4),),
    'mp_mode':MPI,
